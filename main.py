...
#load the dataset
df=pd.read_csv(r'C:\Users\komal\Desktop\movierecommender system komal\Movie-Recommendation-System\movie_metadata.csv')
...
def get_id(tittle):
    if tittle in df.movie_title.unique():
        ...
        return -1         
df1=pd.read_csv(r'C:\Users\komal\Desktop\movierecommender system komal\Movie-Recommendation-System\movies.csv')
df2=pd.read_csv(r'C:\Users\komal\Desktop\movierecommender system komal\Movie-Recommendation-System\ratings.csv\ratings.csv')
